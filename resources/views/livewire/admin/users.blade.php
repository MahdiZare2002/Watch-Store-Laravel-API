<div class="card-body">
    <div class="table overflow-auto" tabindex="8">
        <div class="form-group row">
            ...
            <div class="col-sm-10">
                <input type="text" class="form-control text-left" dir="rtl" placeholder="جستجو" wire:model.live="search">
            </div>
        </div>
        <table class="table table-striped table-hover">
            ...
            @foreach($users as $key => $user)
                <tr>
                    ...
                    <td class="text-center align-middle">{{($user->mobile) ? $user->mobile : '-'}}</td>
                    <td class="text-center align-middle">
