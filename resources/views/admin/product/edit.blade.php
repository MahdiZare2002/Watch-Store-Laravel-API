                ...
                <div class="container">
                    ...
                    <form method="POST" action="{{route('products.update',$product->id)}}"
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" value="{{$product->title}}" class="form-control text-left" dir="rtl"
                                       name="title">
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" value="{{$product->title_en}}" class="form-control text-left"
                                       dir="rtl" name="title_en">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-sm-2 col-form-label">قیمت محصول</label>
                            <div class="col-sm-10">
                                <input type="text" value="{{$product->price}}" class="form-control text-left" dir="rtl"
                                       name="price">
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" value="{{$product->count}}" class="form-control text-left" dir="rtl"
                                       name="count">
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" value="{{$product->guaranty}}" class="form-control text-left"
                                       dir="rtl" name="guaranty">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-sm-2 col-form-label">تخفیف محصول</label>
                            <div class="col-sm-10">
                                <input type="text" value="{{$product->discount}}" class="form-control text-left"
                                       dir="rtl" name="discount">
                            </div>
                        </div>
                        <div class="form-group row">
                        ...
                        <div class="form-group row">
                            <div class="col-sm-3">
                                <div class="custom-control custom-checkbox">
                                    <input type="checkbox" @if($product->is_special) checked
                                           @endif class="custom-control-input" id="customCheck" name="is_special">
                            ...
                            <div class="col-sm-6">
                                <input value="{{\Hekmatinasser\Verta\Verta::instance($product->special_expiration)}}"
                                       type="text" id="special_expiration" class="text-left form-control" dir="rtl"
